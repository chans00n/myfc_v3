              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="mt-4 text-muted-foreground">
                    Have questions about MYFC? We're here to help. Fill out the form and our team will get back to you as soon as possible.
                  </p>
                </div>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">support@myfacecoach.com</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <div className="rounded-full bg-primary/10 p-1">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">123 Fitness Street, San Francisco, CA 94103</p>
                    </div>
                  </div>
                </div>
              </div>
